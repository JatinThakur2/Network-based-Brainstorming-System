    ...
    <div class="layout-px-spacing">
      ...
      <div class="page-header">
        <div class="page-title">
          <h3>Schedule an Brainstorming Session</h3>
        </div>
      </div>
                      ...
                      <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 mt-md-0 mt-4">
                          <div class="form">
                            <div class="row">
                              <div class="col-sm-6">
                                <div class="form-group">
                                  <label for="Student Name">Session Name</label>
                            ...
                            <div class="row">
                              <div class="col-sm-6">
                                <div class="form-group">
                                  ...
                                  <input type="time" class="form-control mb-4" placeholder="Session Time">
                                </div>
                              </div>
                              <div class="col-sm-6">
                            ...
                            <div class="row">
                              <div class="col-sm-6">
                                <label>Session Client-1</label>
                                <div class="form-group mr-1">
                                  <select class="form-control" id="session">
                                    <option>Select Client</option>
                                    <option>Client ID-1</option>
                                    <option>Client ID-2</option>
                                    <option>Client ID-3</option>
                                  </select>
                                </div>
                              </div>
                              <div class="col-sm-6">
                                <label>Session Client-2</label>
                                <div class="form-group mr-1">
                                  <select class="form-control" id="session">
                                    <option>Select Client</option>
                                    <option>Client ID-1</option>
