                ...
                <table class="table" style="width:100%">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Daya</td>
                      <td>Air Pollution</td>
                      <td>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam, dolorum.</td>
                      <td class="text-center"><button class="btn btn-danger">High</button></td>
                      <td class="text-center"><button class="btn btn-success">Approve</button></td>
                      <td class="text-center"><button class="btn btn-info">Details</button></td>
                    </tr>
                    <tr>
                      <td>2514</td>
                      <td>Daya</td>
